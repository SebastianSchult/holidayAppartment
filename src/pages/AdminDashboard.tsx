...
export default function AdminDashboard() {
  const [tab, setTab] = useState<"property" | "seasons" | "taxes">("property");
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-amber-900">
                Bitte lege zuerst unter <strong>Stammdaten</strong> eine Unterkunft an. Danach kannst du hier Saisonpreise erfassen.
              </div>
            )}
          </div>
        )}
        {tab === "taxes" && (
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 text-amber-900">
                Bitte lege zuerst unter <strong>Stammdaten</strong> eine Unterkunft an. Danach kannst du hier Kurtaxe-Bänder erfassen.
              </div>
            )}
          </div>
        )}
